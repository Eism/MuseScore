...
public:
    ...
    void setDockOrientation(const QString& dockName, framework::Orientation orientation) override;
    async::Channel<std::pair<QString, framework::Orientation>> dockOrientationChanged() const override;
