...
public:
    ...
    virtual void setDockOrientation(const QString& dockName, framework::Orientation orientation) = 0;
    virtual async::Channel<std::pair<QString, framework::Orientation>> dockOrientationChanged() const = 0;
};
}
