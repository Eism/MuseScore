...
class NoteInputBarCustomiseModel : public QAbstractListModel, public async::Asyncable
{
    ...
    INJECT(notation, INotationConfiguration, configurator)
    ...
    Q_PROPERTY(
        bool isAddSeparatorAvailable READ isAddSeparatorAvailable WRITE setIsAddSeparatorAvailable NOTIFY isAddSeparatorAvailableChanged)
